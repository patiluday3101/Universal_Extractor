...
#         if len(longest_number) >= 10:  # Ensure it's long enough to be a consumer number
...
#     # Extract Sanction Load (KW)
#     load_patterns = [
#         r'Load\s*:?\s*(\d+(?:\.\d+)?)',  # Simple Load pattern
...
#     # Extract Energy/Electricity Charges
#     charges_patterns = [
#         r'Energy charges\s+(\d+\.?\d*)',  # Energy charges 9589.45
...
#     # Extract Taxes and Fees (Electric Duty, Tax, etc.)
#     tax_patterns = [
#         r'Electric duty\s+(\d+)',  # Electric duty 987
#         r'Tax\s*:?\s*(\d+(?:\.\d+)?)',
#         r'Duty\s*:?\s*(\d+(?:\.\d+)?)',
#     ]
    
#     total_taxes = 0
#     # Sum up all tax-related charges
...
#     # Extract Penalty/Interest charges
#     penalty_patterns = [
#         r'Penalty\s*:?\s*(\d+(?:\.\d+)?)',
#         r'Late.*charge\s*:?\s*(\d+(?:\.\d+)?)',
#         r'Surcharge\s*:?\s*(\d+(?:\.\d+)?)',
#         r'Interest on ED\s+(\d+\.?\d*)',  # Interest on ED 4.02
#     ]
